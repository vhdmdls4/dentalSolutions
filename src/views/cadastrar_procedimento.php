...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <form id="registrarProcedimento" action="" aria-label="Formulário de Cadastro de Procedimento" title="Formulário de cadastro de procedimento">
        ...
        <div class="mb-3">
            <label for="tempo" class="form-label" aria-label="Tempo" title="Tempo estimado de duracao do procedimento">Tempo:</label>
            <input type="number" class="form-control" id="tempo" name="tempo" aria-required="true" aria-label="Tempo" title="Tempo estimado de duracao do procedimento" placeholder="Digite o tempo de duracao aqui..." required>
        </div>
        <div class="mb-3">
