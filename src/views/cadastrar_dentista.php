...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="min-height: 1480px;">

    <h2 class="mt-5">Cadastro de Dentista Funcionário</h2>
    <form id="cadastrarDentistaFuncionario" action="" aria-label="Formulário de Cadastro de Dentista Funcionário">
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <div class="input-group">
            ...
            <input type="number" class="form-control" id="salario" name="salario" placeholder="Digite o salário" required>
        </div>
    </div>
    ...
    <script type="module">
      ...
      handleFormSubmit('cadastrarDentistaFuncionario', '../controllers/DentistaController.php');
    </script>
</main>
